...
| v4.2 | 2026-05-12 | BGE 有监督微调；热点语义晋升+10min TTL；聚类维护(合并/拆分)；情感守卫 |
| v4.3 | 2026-05-13 | 单表缓存(去掉 stage 维度)；Alias+Variant 合并为统一 Normalizer(jieba+相邻合并)；拼音可信验证；BGE-base 支持；MIT 开源 |
